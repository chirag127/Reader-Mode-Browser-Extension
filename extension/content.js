...
async function activateReaderMode() {
  ...
  try {
    ...
    createReaderModeUI(response.content);
...
function createReaderModeUI(content) {
  ...
  readerContainer.className = currentSettings.theme === 'dark' ? 'dark-theme' : 'light-theme';
...
function createToolbar() {
  ...
  themeToggle.title = currentSettings.theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode';
...
function createFloatingControls() {
  ...
  controlsContainer.className = currentSettings.theme === 'dark' ? 'dark-theme' : 'light-theme';
...
function showLoadingIndicator() {
  ...
  loadingIndicator.innerHTML = '<div class="spinner"></div><p>Loading Reader Mode...</p>';
...
function showErrorMessage(message) {
  ...
  errorMessage.querySelector('#reader-error-close').addEventListener('click', () => {
    errorMessage.remove();
  });
